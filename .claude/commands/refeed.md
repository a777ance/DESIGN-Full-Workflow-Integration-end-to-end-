...
1. `CLAUDE.md` — the short briefing.
2. `README.md` — the full stage-by-stage funnel guide.
3. `workflow-context.md` — the *why* behind the non-obvious calls.
4. `docs/ai-cto/portfolio.md` — cross-repo status, priorities, and the phase gate (the portfolio hub).
