...
| -- | ---- | -------- | ---- | ------ |
| TD-15 | Claude usage not cost-tuned: routines default to Opus 4.8 + high effort; bulk/non-interactive LLM work isn't on the Batches API (−50%); the local Odin/LiteLLM ladder is idle for offload; house-style block duplicated 6×. Concrete fixes + impact bands in `docs/ai-cto/process-efficiency.md` (2026-06-16). Local offload blocked on TD-14. | P2 | all | Open (found 2026-06-16) |
