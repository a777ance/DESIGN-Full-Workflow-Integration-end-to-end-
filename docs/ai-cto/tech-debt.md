...
| -- | ---- | -------- | ---- | ------ |
| TD-15 | CLAUDE.md files are oversized (localDNS ~400 lines, DESIGN similar) and duplicate README/INSTALL-NOTES content — every Claude session re-pays this as fixed context on every turn. Trim each to a ~150-line index that links out (Anthropic guidance: keep under ~200 lines). See `docs/ai-cto/process-efficiency.md`. | P2 | all | Open (found 2026-06-22) |
