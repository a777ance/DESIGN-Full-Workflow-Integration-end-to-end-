...
| -- | ---- | -------- | ---- | ------ |
| TD-15 | Human↔AI process efficiency: bulk jobs not on Batch API (50% off), cache-hit ratio unverified, model selection Opus-heavy by habit, full ~300-line CLAUDE.md loaded into single-stage edits. Full analysis + ranked fixes in `docs/ai-cto/process-efficiency-review.md`. | P2 | DESIGN | Open (found 2026-06-16) |
