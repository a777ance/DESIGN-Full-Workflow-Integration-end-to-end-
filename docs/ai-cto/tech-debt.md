...
| -- | ---- | -------- | ---- | ------ |
| TD-15 | AI-process cost exposure: as of 2026-06-15 Anthropic meters autonomous/programmatic usage (scheduled routines, GitHub Actions, `claude -p`, Agent SDK) against a capped monthly credit ($20 Pro / $100 Max-5x / $200 Max-20x), then bills at API rates. Our NARF/ZORT routines and CI run on this credit. Fix: scope recurring runs (diff vs. last review, not re-derive), route low-stakes jobs to the local rig (stage 10), right-size model/effort. Full plan: `docs/ai-cto/ai-process-efficiency.md`. ZORT to model tier vs. overage in `docs/ai-cfo/budget.md`. | P1 | DESIGN | Open (found 2026-06-15) |
